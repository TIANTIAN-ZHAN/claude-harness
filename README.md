...
This is the toolkit. Four skills, five minutes per repo.
...
- **`CLAUDE.md`** — commands, conventions, three-tier boundaries (✅ Always / ⚠️ Ask first / 🚫 Never). Capped at 150 lines so it stays in context cheaply.
